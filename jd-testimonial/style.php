...
#<?php echo $id ?> .swiper-button-next {
  ...
  height:50px;
  line-height:50px;
  <?php Css::prop('background', $field['nav_color']); ?>
}
#<?php echo $id ?> .swiper-button-next{
...
#<?php echo $id ?> .swiper-button-prev {left:0; margin-top: -60px;}
#<?php echo $id ?> .swiper-button-next {right:0; margin-top: -60px;}
...
#<?php echo $id ?> .swiper-button-prev::before {content:'\f177';left:5px;}
#<?php echo $id ?> .swiper-button-next::before {content:'\f178';right:5px;}
#<?php echo $id ?> .swiper-pagination {
  position:initial;
}
#<?php echo $id ?> .swiper-pagination-bullet.swiper-pagination-bullet-active {
