...
<div class="swiper-wrapper">
    <?php foreach( $field['carousels'] as $testimonial ):?><?php $animation_delay += 0.1;?>
		<div class="qx-carousel-item swiper-slide jd-testimonial-wrapper <?php echo $animation_class . $hover_animation?>" <?php echo ($field['animation']) ? 'data-wow-delay="'. $animation_delay .'s"' : '';?>>
				<div class="author-image-wrap d-flex flex-column flex-sm-row align-items-center">
					<div class="img-name-company">
						<?php if($testimonial['image']):?>
						  <img class="<?php echo $field['image_style']?>" src="<?php echo $testimonial['image']?>" alt="<?php echo $testimonial['name']?>">
						<?php endif;?>
						<div class="author-content-wrap">
							<span class="person-name"><?php echo $testimonial['name']?></span>
							<p class="qx-designation qx-text-muted"><?php echo $testimonial['position']?></p>
						</div>
					</div>
				</div>      
				<div class="author-content">
					<div class="qx-testimony">
						<i class="fa fa-quote-left left-icon" aria-hidden="true"></i><?php echo $testimonial['description']?>
					</div>
				</div>
		</div>
    <?php endforeach; ?>  
